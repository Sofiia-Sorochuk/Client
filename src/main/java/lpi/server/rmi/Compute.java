...
public interface Compute extends Remote {
    ...
    long timeProcesMethod(Sort sort) throws RemoteException;

    interface Task<T> {
        T execute();
    }

    class Sort implements Task<byte[]>, Serializable {
        ...
        public void setTimeConsumedMilis(long timeConsumedMilis) {
            Sort.timeConsumedMilis = timeConsumedMilis;
        }
    ...
    class Sum implements Task<Integer>, Serializable {
